...
public class ModItems {
    ...
    public static final Item dol_decoction = registerItem("dol_decoction", new Item(new FabricItemSettings().food(new FoodComponent.Builder().hunger(3).alwaysEdible().statusEffect(new StatusEffectInstance(StatusEffects.DOLPHINS_GRACE,20*600), 1).build()).group(ModItemGroup.CHICKEN_MADNESS)));
    public static final Item rapka_decoction = registerItem("rapka_decoction", new Item(new FabricItemSettings().food(new FoodComponent.Builder().hunger(3).alwaysEdible().statusEffect(new StatusEffectInstance(StatusEffects.SPEED,20*600,1), 1).statusEffect(new StatusEffectInstance(StatusEffects.JUMP_BOOST,20*600,1), 1).statusEffect(new StatusEffectInstance(StatusEffects.HASTE,20*600,1), 1).build()).group(ModItemGroup.CHICKEN_MADNESS)));
    public static final Item decoction_of_luck = registerItem("decoction_of_luck", new Item(new FabricItemSettings().food(new FoodComponent.Builder().hunger(3).alwaysEdible().statusEffect(new StatusEffectInstance(StatusEffects.LUCK,20*600,5), 1).build()).group(ModItemGroup.CHICKEN_MADNESS)));
