...
public class ModItems {
    ...
    public static final Item decoction_of_luck = registerItem("decoction_of_luck", new Item(new FabricItemSettings().food(new FoodComponent.Builder().saturationModifier(0.4f).hunger(6).alwaysEdible().statusEffect(new StatusEffectInstance(StatusEffects.LUCK,20*600,90), 1).build()).group(ModItemGroup.CHICKEN_MADNESS)));
